	...
	public class StructuralEqualityComparerTestForUnified {
		...
		public void compares_equal_expressions() {
			var o1 = UnifiedBinaryExpression.Create(
					UnifiedIdentifier.Create("n", UnifiedIdentifierKind.Unknown),
		...
		public void compares_different_expressions_containing_null() {
			var o1 = UnifiedBinaryExpression.Create(
					UnifiedIdentifier.Create("n", UnifiedIdentifierKind.Unknown), null, UnifiedIntegerLiteral.Create(1, UnifiedIntegerLiteralKind.Int32));
			var o2 = UnifiedBinaryExpression.Create(
					UnifiedIdentifier.Create("n", UnifiedIdentifierKind.Unknown),
		...
		public void compares_equal_Call() {
			var o1 = UnifiedCall.Create(UnifiedIdentifier.Create("f", UnifiedIdentifierKind.Unknown), UnifiedArgumentCollection.Create(
					UnifiedArgument.Create(null, null, UnifiedIdentifier.Create("a", UnifiedIdentifierKind.Unknown)),
					UnifiedArgument.Create(null, null, UnifiedBinaryExpression.Create(
							UnifiedIdentifier.Create("n", UnifiedIdentifierKind.Unknown),
							UnifiedBinaryOperator.Create("-", UnifiedBinaryOperatorKind.Add),
							UnifiedIntegerLiteral.Create(1, UnifiedIntegerLiteralKind.Int32)))));
			var o2 = UnifiedCall.Create(UnifiedIdentifier.Create("f", UnifiedIdentifierKind.Unknown), UnifiedArgumentCollection.Create(
					UnifiedArgument.Create(null, null, UnifiedIdentifier.Create("a", UnifiedIdentifierKind.Unknown)),
					UnifiedArgument.Create(null, null, UnifiedBinaryExpression.Create(
							UnifiedIdentifier.Create("n", UnifiedIdentifierKind.Unknown),
							UnifiedBinaryOperator.Create("-", UnifiedBinaryOperatorKind.Add),
		...
		public void compares_different_calls() {
			...
			var o2 = UnifiedCall.Create(UnifiedIdentifier.Create("f", UnifiedIdentifierKind.Unknown), UnifiedArgumentCollection.Create(
					UnifiedArgument.Create(null, null, UnifiedIdentifier.Create("a", UnifiedIdentifierKind.Unknown)),
					UnifiedArgument.Create(null, null, UnifiedBinaryExpression.Create(
							UnifiedIdentifier.Create("n2", UnifiedIdentifierKind.Unknown),
							UnifiedBinaryOperator.Create("-", UnifiedBinaryOperatorKind.Add),
							UnifiedIntegerLiteral.Create(1, UnifiedIntegerLiteralKind.Int32)))));
			Assert.That(
					StructuralEqualityComparer.StructuralEquals(o1, o2),
