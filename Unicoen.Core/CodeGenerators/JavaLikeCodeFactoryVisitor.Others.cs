...
namespace Unicoen.CodeGenerators {
    public partial class JavaLikeCodeFactoryVisitor {
        ...
        public override bool Visit(
                UnifiedInt8Literal element, VisitorArgument arg) {
            Writer.Write(element.Value);
            return false;
        }

        public override bool Visit(
                UnifiedInt16Literal element, VisitorArgument arg) {
            Writer.Write(element.Value);
            return false;
        }

        public override bool Visit(
                UnifiedInt31Literal element, VisitorArgument arg) {
            Writer.Write(element.Value);
            return false;
        }
        ...
        public override bool Visit(
                UnifiedUInt31Literal element, VisitorArgument arg) {
            Writer.Write(element.Value);
            return false;
        }
        ...
        public override bool Visit(UnifiedExpressionList element, VisitorArgument arg) {
            Writer.Write("(");
            foreach (var exp in element) {
                if (exp.TryAccept(this, arg)) {
                    Writer.Write(",");
                }
            }
            Writer.Write(")");
