	...
	public static class ModelFactoryForModel {
		...
		public static UnifiedFunctionDefinition ToFunctionDefinition(this string name) {
			return UnifiedFunctionDefinition.Create(
					...
					null, UnifiedModifierCollection.Create(), null, null, UnifiedIdentifier.Create(name, UnifiedIdentifierKind.Function), UnifiedParameterCollection.Create(), null, UnifiedBlock.Create());
		}
