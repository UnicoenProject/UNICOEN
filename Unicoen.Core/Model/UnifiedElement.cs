...
namespace Unicoen.Model {
	public abstract partial class UnifiedElement : ICopiable {
		...
		/// </summary>
		/// <returns> 子要素 </returns>
		public virtual IEnumerable<UnifiedElement> Elements() {
			return FieldInfos.Select(f => (UnifiedElement)f.GetValue(this));
		}
		...
		/// </summary>
		/// <returns> 親要素 </returns>
		public UnifiedElement RemoveSelf() {
		...
		/// <returns> </returns>
		public T SetChild<T>(T child, UnifiedElement oldChild)
