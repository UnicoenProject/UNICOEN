...
namespace Unicoen.Model {
	...
	public class UnifiedOrderByQuery : UnifiedLinqQuery {
		...
		public static UnifiedOrderByQuery Create(
				UnifiedSet<UnifiedOrderByKey> keys) {
