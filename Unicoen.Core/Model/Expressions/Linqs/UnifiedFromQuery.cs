...
namespace Unicoen.Model {
	/// <summary>
	///   LINQのクエリ式を構成するfrom句を表します。 e.g. C#における <c>from int element in array</c>
	/// </summary>
	public class UnifiedFromQuery : UnifiedLinqQuery {
		...
		private UnifiedExpression _source;

		/// <summary>
		///   fromで受け取る変数の型を取得もしくは設定します． e.g. C#における <c>from int element in array</c> の <c>int</c>
		/// </summary>
		...
		/// <summary>
		///   要素を受け取る変数を取得もしくは設定します． e.g. C#における <c>from int element in array</c> の <c>element</c>
		/// </summary>
		...
		/// <summary>
		///   クエリ式の対象となる式を取得もしくは設定します． e.g. C#における <c>from int element in array</c> の <c>array</c>
		/// </summary>
		public UnifiedExpression Source {
			get { return _source; }
