...
namespace Unicoen.Model {
	...
	public abstract class UnifiedElementCollectionBase<TElement, TSelf>
			: UnifiedElement, IUnifiedCreatable<TSelf>,
			  IUnifiedElementCollection<TElement>, ICopiable
			where TElement : UnifiedElement
			where TSelf : UnifiedElementCollectionBase<TElement, TSelf> {
		...
		UnifiedElement ICopiable.PrivateDeepCopy() {
			var ret =
					(UnifiedElementCollectionBase<TElement, TSelf>)MemberwiseClone();
			ret.Parent = null;
