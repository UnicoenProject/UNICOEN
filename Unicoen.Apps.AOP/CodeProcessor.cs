...
namespace Unicoen.Apps.Aop {
	...
	public class CodeProcessor
	{
		...
		public static IEnumerable<IUnifiedElement> GetElementsByType(IUnifiedElement root, Type type) {
			foreach (var e in root.Descendants()) {
		...
		public static void InsertAtBeforeExecution(IUnifiedElement root, Regex regex, string advice) {
			//get function list
		...
		/// <param name="regex">対象関数を指定する正規表現</param>
		/// <param name="advice">挿入するコード断片</param>
		public static void InsertAtAfterExecution(IUnifiedElement root, Regex regex, string advice) {
			//get function list
			var functions =  GetElementsByType<UnifiedFunctionDefinition>(root);
			//create advice as model
			var actual = CreateAdvice(advice);
		...
		/// <param name="root">コードを追加するモデルのルートノード</param>
		/// <param name="advice">挿入するコード断片</param>
		public static void InsertAtBeforeExecutionAll(IUnifiedElement root, string advice) {
		...
		/// <param name="root">コードを追加するモデルのルートノード</param>
		/// <param name="advice">挿入するコード断片</param>
		public static void InsertAtAfterExecutionAll(IUnifiedElement root, string advice) {
		...
		/// <param name="advice">挿入するコード断片</param>
		public static void InsertAtBeforeExecutionByName(IUnifiedElement root, string name, string advice) {
		...
		/// <param name="name">対象関数の名前</param>
		/// <param name="advice">挿入するコード断片</param>
		public static void InsertAtAfterExecutionByName(IUnifiedElement root, string name, string advice) {
		...
		/// <param name="regex">対象関数を指定する正規表現</param>
		/// <param name="advice">挿入するコード断片</param>
		public static void InsertAtBeforeCall(IUnifiedElement root, Regex regex, string advice) {
			//get cass list
		...
		/// <param name="regex">対象関数を指定する正規表現</param>
		/// <param name="advice">挿入するコード断片</param>
		public static void InsertAtAfterCall(IUnifiedElement root, Regex regex, string advice) {
			//get cass list
			var calls = GetElementsByType<UnifiedCall>(root).ToList();
			//create advice as model
			var actual = CreateAdvice(advice);
		...
		/// <param name="name">対象関数の名前</param>
		/// <param name="advice">挿入するコード断片</param>
		public static void InsertAtBeforeCallByName(IUnifiedElement root, string name, string advice) {
		...
		/// <param name="name">対象関数の名前</param>
		/// <param name="advice">挿入するコード断片</param>
		public static void InsertAtAfterCallByName(IUnifiedElement root, string name, string advice) {
