// $ANTLR 3.2 Sep 23, 2009 12:02:23 C.g 2010-03-22 18:20:25
...
public partial class CLexer : Lexer {
    ...
    public void mIDENTIFIER() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:614:2: ( LETTER ( LETTER | '0' .. '9' )* )
            // C.g:614:4: LETTER ( LETTER | '0' .. '9' )*
            {
            	mLETTER(); 
            	// C.g:614:11: ( LETTER | '0' .. '9' )*
            	do 
            	{
            	    int alt1 = 2;
    ...
    public void mCHARACTER_LITERAL() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:626:5: ( '\\'' ( EscapeSequence | ~ ( '\\'' | '\\\\' ) ) '\\'' )
            // C.g:626:9: '\\'' ( EscapeSequence | ~ ( '\\'' | '\\\\' ) ) '\\''
            {
            	Match('\''); 
            	// C.g:626:14: ( EscapeSequence | ~ ( '\\'' | '\\\\' ) )
            	int alt2 = 2;
    ...
    public void mSTRING_LITERAL() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:630:5: ( '\"' ( EscapeSequence | ~ ( '\\\\' | '\"' ) )* '\"' )
            // C.g:630:8: '\"' ( EscapeSequence | ~ ( '\\\\' | '\"' ) )* '\"'
            {
            	Match('\"'); 
            	// C.g:630:12: ( EscapeSequence | ~ ( '\\\\' | '\"' ) )*
            	do 
            	{
            	    int alt3 = 3;
    ...
    public void mHEX_LITERAL() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:633:13: ( '0' ( 'x' | 'X' ) ( HexDigit )+ ( IntegerTypeSuffix )? )
            // C.g:633:15: '0' ( 'x' | 'X' ) ( HexDigit )+ ( IntegerTypeSuffix )?
            {
            	Match('0'); 
    ...
    public void mDECIMAL_LITERAL() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:635:17: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( IntegerTypeSuffix )? )
            // C.g:635:19: ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( IntegerTypeSuffix )?
            {
            	// C.g:635:19: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            	int alt7 = 2;
    ...
    public void mOCTAL_LITERAL() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:637:15: ( '0' ( '0' .. '7' )+ ( IntegerTypeSuffix )? )
            // C.g:637:17: '0' ( '0' .. '7' )+ ( IntegerTypeSuffix )?
            {
            	Match('0'); 
            	// C.g:637:21: ( '0' .. '7' )+
            	int cnt9 = 0;
    ...
    public void mHexDigit() // throws RecognitionException [2]
    {
    		try
    		{
            // C.g:640:10: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // C.g:640:12: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            {
    ...
    public void mFLOATING_POINT_LITERAL() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:649:5: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )? | '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )? | ( '0' .. '9' )+ Exponent ( FloatTypeSuffix )? | ( '0' .. '9' )+ ( Exponent )? FloatTypeSuffix )
            int alt25 = 4;
            alt25 = dfa25.Predict(input);
            switch (alt25) 
            {
                case 1 :
                    // C.g:649:9: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )?
                    {
                    	// C.g:649:9: ( '0' .. '9' )+
                    	int cnt14 = 0;
                    	do 
                    ...
                    break;
                case 2 :
                    // C.g:650:9: '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )?
                    {
                    	Match('.'); 
                    	// C.g:650:13: ( '0' .. '9' )+
                    	int cnt18 = 0;
                    ...
                    break;
                case 3 :
                    // C.g:651:9: ( '0' .. '9' )+ Exponent ( FloatTypeSuffix )?
                    {
                    	// C.g:651:9: ( '0' .. '9' )+
                    	int cnt21 = 0;
                    	do 
                    ...
                    break;
                case 4 :
                    // C.g:652:9: ( '0' .. '9' )+ ( Exponent )? FloatTypeSuffix
                    {
                    	// C.g:652:9: ( '0' .. '9' )+
                    	int cnt23 = 0;
                    	do 
    ...
    public void mEscapeSequence() // throws RecognitionException [2]
    {
    		try
    		{
            // C.g:663:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | OctalEscape )
            int alt28 = 2;
    ...
    public void mOctalEscape() // throws RecognitionException [2]
    {
    		try
    		{
            // C.g:669:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            int alt29 = 3;
    ...
    public void mUnicodeEscape() // throws RecognitionException [2]
    {
    		try
    		{
            // C.g:676:5: ( '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit )
            // C.g:676:9: '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit
            {
            	Match('\\'); 
            	Match('u'); 
            	mHexDigit(); 
    ...
    public void mCOMMENT() // throws RecognitionException [2]
    {
            ...
            int _type = COMMENT;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:683:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // C.g:683:9: '/*' ( options {greedy=false; } : . )* '*/'
            {
            	Match("/*"); 

            	// C.g:683:14: ( options {greedy=false; } : . )*
            	do 
            	{
            	    int alt30 = 2;
    ...
    protected class DFA25 : DFA
    {
        ...
        {
            get { return "648:1: FLOATING_POINT_LITERAL : ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )? | '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )? | ( '0' .. '9' )+ Exponent ( FloatTypeSuffix )? | ( '0' .. '9' )+ ( Exponent )? FloatTypeSuffix );"; }
        }
