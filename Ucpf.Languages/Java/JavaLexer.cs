// $ANTLR 3.2 Sep 23, 2009 12:02:23 Java.g 2010-08-13 02:31:39
...
public partial class JavaLexer : Lexer {
    ...
    public void mLONGLITERAL() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1525:5: ( IntegerNumber LongSuffix )
            // Java.g:1525:9: IntegerNumber LongSuffix
            {
            	mIntegerNumber(); 
            	mLongSuffix(); 
    ...
    public void mINTLITERAL() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1530:5: ( IntegerNumber )
            // Java.g:1530:9: IntegerNumber
            {
            	mIntegerNumber(); 
    ...
    public void mIntegerNumber() // throws RecognitionException [2]
    {
    		try
    		{
            // Java.g:1535:5: ( '0' | '1' .. '9' ( '0' .. '9' )* | '0' ( '0' .. '7' )+ | HexPrefix ( HexDigit )+ )
            int alt4 = 4;
            ...
            switch (alt4) 
            {
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // Java.g:1538:9: HexPrefix ( HexDigit )+
                    {
                    	mHexPrefix(); 
                    	// Java.g:1538:19: ( HexDigit )+
                    	int cnt3 = 0;
                    	do 
                    	{
                    	    int alt3 = 2;
    ...
    public void mHexDigit() // throws RecognitionException [2]
    {
    		try
    		{
            // Java.g:1548:5: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // Java.g:1548:9: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            {
    ...
    public void mNonIntegerNumber() // throws RecognitionException [2]
    {
    		try
    		{
            // Java.g:1559:5: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? | '.' ( '0' .. '9' )+ ( Exponent )? | ( '0' .. '9' )+ Exponent | ( '0' .. '9' )+ | HexPrefix ( HexDigit )* ( () | ( '.' ( HexDigit )* ) ) ( 'p' | 'P' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            int alt18 = 5;
            alt18 = dfa18.Predict(input);
            switch (alt18) 
            {
                case 1 :
                    // Java.g:1559:9: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )?
                    {
                    	// Java.g:1559:9: ( '0' .. '9' )+
                    	int cnt6 = 0;
                    	do 
                ...
                case 4 :
                    ...
                    break;
                case 5 :
                    // Java.g:1564:9: HexPrefix ( HexDigit )* ( () | ( '.' ( HexDigit )* ) ) ( 'p' | 'P' ) ( '+' | '-' )? ( '0' .. '9' )+
                    {
                    	mHexPrefix(); 
                    	// Java.g:1564:19: ( HexDigit )*
                    	do 
                    	{
                    	    int alt13 = 2;
                    	...
                    	switch (alt15) 
                    	{
                    	    case 1 :
                    	        ...
                    	        break;
                    	    case 2 :
                    	        // Java.g:1566:14: ( '.' ( HexDigit )* )
                    	        {
                    	        	// Java.g:1566:14: ( '.' ( HexDigit )* )
                    	        	// Java.g:1566:15: '.' ( HexDigit )*
                    	        	{
                    	        		Match('.'); 
                    	        		// Java.g:1566:19: ( HexDigit )*
                    	        		do 
                    	        		{
                    	        		    int alt14 = 2;
    ...
    public void mExponent() // throws RecognitionException [2]
    {
    		try
    		{
            // Java.g:1575:5: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            // Java.g:1575:9: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
            {
    ...
    public void mFLOATLITERAL() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1589:5: ( NonIntegerNumber FloatSuffix )
            // Java.g:1589:9: NonIntegerNumber FloatSuffix
            {
            	mNonIntegerNumber(); 
            	mFloatSuffix(); 
    ...
    public void mDOUBLELITERAL() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1593:5: ( NonIntegerNumber ( DoubleSuffix )? )
            // Java.g:1593:9: NonIntegerNumber ( DoubleSuffix )?
            {
            	mNonIntegerNumber(); 
            	// Java.g:1593:26: ( DoubleSuffix )?
            	int alt21 = 2;
    ...
    public void mCHARLITERAL() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1597:5: ( '\\'' ( EscapeSequence | ~ ( '\\'' | '\\\\' | '\\r' | '\\n' ) ) '\\'' )
            // Java.g:1597:9: '\\'' ( EscapeSequence | ~ ( '\\'' | '\\\\' | '\\r' | '\\n' ) ) '\\''
            {
            	Match('\''); 
            	// Java.g:1598:9: ( EscapeSequence | ~ ( '\\'' | '\\\\' | '\\r' | '\\n' ) )
            	int alt22 = 2;
    ...
    public void mSTRINGLITERAL() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1605:5: ( '\"' ( EscapeSequence | ~ ( '\\\\' | '\"' | '\\r' | '\\n' ) )* '\"' )
            // Java.g:1605:9: '\"' ( EscapeSequence | ~ ( '\\\\' | '\"' | '\\r' | '\\n' ) )* '\"'
            {
            	Match('\"'); 
            	// Java.g:1606:9: ( EscapeSequence | ~ ( '\\\\' | '\"' | '\\r' | '\\n' ) )*
            	do 
            	{
            	    int alt23 = 3;
    ...
    public void mEscapeSequence() // throws RecognitionException [2]
    {
    		try
    		{
            // Java.g:1614:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ) )
            // Java.g:1614:9: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) )
            {
            	Match('\\'); 
            	// Java.g:1614:14: ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) )
            	int alt24 = 11;
    ...
    public void mCOMMENT() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            ...
            // Java.g:1649:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // Java.g:1649:9: '/*' ( options {greedy=false; } : . )* '*/'
            {
            	Match("/*"); 
            	...
            	// Java.g:1655:9: ( options {greedy=false; } : . )*
            	do 
            	{
            	    int alt25 = 2;
    ...
    public void mABSTRACT() // throws RecognitionException [2]
    {
            ...
            int _type = ABSTRACT;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1678:5: ( 'abstract' )
            // Java.g:1678:9: 'abstract'
            {
            	Match("abstract"); 
    ...
    public void mASSERT() // throws RecognitionException [2]
    {
            ...
            int _type = ASSERT;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1682:5: ( 'assert' )
            // Java.g:1682:9: 'assert'
            {
            	Match("assert"); 
    ...
    public void mBOOLEAN() // throws RecognitionException [2]
    {
            ...
            int _type = BOOLEAN;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1686:5: ( 'boolean' )
            // Java.g:1686:9: 'boolean'
            {
            	Match("boolean"); 
    ...
    public void mCONTINUE() // throws RecognitionException [2]
    {
            ...
            int _type = CONTINUE;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1718:5: ( 'continue' )
            // Java.g:1718:9: 'continue'
            {
            	Match("continue"); 
    ...
    public void mDEFAULT() // throws RecognitionException [2]
    {
            ...
            int _type = DEFAULT;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1722:5: ( 'default' )
            // Java.g:1722:9: 'default'
            {
            	Match("default"); 
    ...
    public void mDOUBLE() // throws RecognitionException [2]
    {
            ...
            int _type = DOUBLE;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1730:5: ( 'double' )
            // Java.g:1730:9: 'double'
            {
            	Match("double"); 
    ...
    public void mEXTENDS() // throws RecognitionException [2]
    {
            ...
            int _type = EXTENDS;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1742:5: ( 'extends' )
            // Java.g:1742:9: 'extends'
            {
            	Match("extends"); 
    ...
    public void mFINALLY() // throws RecognitionException [2]
    {
            ...
            int _type = FINALLY;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1750:5: ( 'finally' )
            // Java.g:1750:9: 'finally'
            {
            	Match("finally"); 
    ...
    public void mIMPLEMENTS() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1770:5: ( 'implements' )
            // Java.g:1770:9: 'implements'
            {
            	Match("implements"); 
    ...
    public void mIMPORT() // throws RecognitionException [2]
    {
            ...
            int _type = IMPORT;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1774:5: ( 'import' )
            // Java.g:1774:9: 'import'
            {
            	Match("import"); 
    ...
    public void mINSTANCEOF() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1778:5: ( 'instanceof' )
            // Java.g:1778:9: 'instanceof'
            {
            	Match("instanceof"); 
    ...
    public void mINTERFACE() // throws RecognitionException [2]
    {
            ...
            int _type = INTERFACE;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1786:5: ( 'interface' )
            // Java.g:1786:9: 'interface'
            {
            	Match("interface"); 
    ...
    public void mNATIVE() // throws RecognitionException [2]
    {
            ...
            int _type = NATIVE;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1794:5: ( 'native' )
            // Java.g:1794:9: 'native'
            {
            	Match("native"); 
    ...
    public void mPACKAGE() // throws RecognitionException [2]
    {
            ...
            int _type = PACKAGE;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1802:5: ( 'package' )
            // Java.g:1802:9: 'package'
            {
            	Match("package"); 
    ...
    public void mPRIVATE() // throws RecognitionException [2]
    {
            ...
            int _type = PRIVATE;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1806:5: ( 'private' )
            // Java.g:1806:9: 'private'
            {
            	Match("private"); 
    ...
    public void mPROTECTED() // throws RecognitionException [2]
    {
            ...
            int _type = PROTECTED;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1810:5: ( 'protected' )
            // Java.g:1810:9: 'protected'
            {
            	Match("protected"); 
    ...
    public void mPUBLIC() // throws RecognitionException [2]
    {
            ...
            int _type = PUBLIC;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1814:5: ( 'public' )
            // Java.g:1814:9: 'public'
            {
            	Match("public"); 
    ...
    public void mRETURN() // throws RecognitionException [2]
    {
            ...
            int _type = RETURN;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1818:5: ( 'return' )
            // Java.g:1818:9: 'return'
            {
            	Match("return"); 
    ...
    public void mSTATIC() // throws RecognitionException [2]
    {
            ...
            int _type = STATIC;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1826:5: ( 'static' )
            // Java.g:1826:9: 'static'
            {
            	Match("static"); 
    ...
    public void mSTRICTFP() // throws RecognitionException [2]
    {
            ...
            int _type = STRICTFP;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1830:5: ( 'strictfp' )
            // Java.g:1830:9: 'strictfp'
            {
            	Match("strictfp"); 
    ...
    public void mSWITCH() // throws RecognitionException [2]
    {
            ...
            int _type = SWITCH;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1838:5: ( 'switch' )
            // Java.g:1838:9: 'switch'
            {
            	Match("switch"); 
    ...
    public void mSYNCHRONIZED() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1842:5: ( 'synchronized' )
            // Java.g:1842:9: 'synchronized'
            {
            	Match("synchronized"); 
    ...
    public void mTHROWS() // throws RecognitionException [2]
    {
            ...
            int _type = THROWS;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1854:5: ( 'throws' )
            // Java.g:1854:9: 'throws'
            {
            	Match("throws"); 
    ...
    public void mTRANSIENT() // throws RecognitionException [2]
    {
            ...
            int _type = TRANSIENT;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1858:5: ( 'transient' )
            // Java.g:1858:9: 'transient'
            {
            	Match("transient"); 
    ...
    public void mVOLATILE() // throws RecognitionException [2]
    {
            ...
            int _type = VOLATILE;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:1870:5: ( 'volatile' )
            // Java.g:1870:9: 'volatile'
            {
            	Match("volatile"); 
    ...
    public void mIDENTIFIER() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:2050:5: ( IdentifierStart ( IdentifierPart )* )
            // Java.g:2050:9: IdentifierStart ( IdentifierPart )*
            {
            	mIdentifierStart(); 
            	// Java.g:2050:25: ( IdentifierPart )*
            	do 
            	{
            	    int alt30 = 2;
    ...
    protected class DFA18 : DFA
    {
        ...
        {
            get { return "1557:1: fragment NonIntegerNumber : ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? | '.' ( '0' .. '9' )+ ( Exponent )? | ( '0' .. '9' )+ Exponent | ( '0' .. '9' )+ | HexPrefix ( HexDigit )* ( () | ( '.' ( HexDigit )* ) ) ( 'p' | 'P' ) ( '+' | '-' )? ( '0' .. '9' )+ );"; }
        }
    ...
    protected class DFA24 : DFA
    {
        ...
        override public string Description
        {
            get { return "1614:14: ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' | ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) ( '0' .. '7' ) | ( '0' .. '7' ) )"; }
        }
    ...
    protected class DFA29 : DFA
    {
        ...
        override public string Description
        {
            get { return "1666:1: LINE_COMMENT : ( '//' (~ ( '\\n' | '\\r' ) )* ( '\\r\\n' | '\\r' | '\\n' ) | '//' (~ ( '\\n' | '\\r' ) )* );"; }
        }
