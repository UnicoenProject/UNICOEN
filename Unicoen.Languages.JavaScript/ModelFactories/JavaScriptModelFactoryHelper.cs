	...
	public static class JavaScriptModelFactoryHelper {
		...
		public static UnifiedFunctionDefinition CreateFunctionDeclaration(
			...
			return UnifiedFunctionDefinition.Create(
					...
					null, UnifiedModifierCollection.Create(), null, null, UnifiedIdentifier.Create(name, UnifiedIdentifierKind.Function), parameters, null, body);
		...
		public static IUnifiedExpression CreateFunctionExpression(XElement node) {
			...
			return UnifiedFunctionDefinition.Create(
					...
					null, null, null, null, UnifiedIdentifier.Create(name, UnifiedIdentifierKind.Function), parameters, null, body);
		}
			...
			var parameters =
					node.Elements("Identifier").Select(
							e => UnifiedParameter.Create(
									null,
									null, null, UnifiedIdentifier.Create(e.Value, UnifiedIdentifierKind.Variable).ToCollection(),
									null)).
							ToCollection();
			return parameters;
		}
		...
		public static UnifiedVariableDefinition
			...
			var name = UnifiedIdentifier.Create(node.NthElement(0).Value, UnifiedIdentifierKind.Variable);
		...
		public static UnifiedSpecialExpression CreateContinueStatement(XElement node) {
			...
			var identifier = node.HasElement("Identifier")
			                 		? UnifiedIdentifier.Create(node.Element("Identifier").Value, UnifiedIdentifierKind.Unknown) : null;
		...
		public static UnifiedCatchCollection CreateCatchClause(XElement node) {
			...
			var matchers =
					UnifiedMatcher.Create(null, null, UnifiedIdentifier.Create(node.Element("Identifier").Value, UnifiedIdentifierKind.Unknown), null)
							.ToCollection();
			var body = CreateStatementBlock(node.Element("statementBlock"));
		...
		public static UnifiedIdentifier CreatePropertyName(XElement node) {
			 ...
			 *		| NumericLiteral
			 */
			return UnifiedIdentifier.Create(node.NthElement(0).Value, UnifiedIdentifierKind.Variable);
		}
