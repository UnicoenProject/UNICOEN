...
namespace Ucpf.Languages.C.Tests
{
	public class CCodeModelTest
	{
		...
		public void TrueBlockが正しく生成できる()
		{
			...
			Assert.That(firstStatement.Expressions.ElementAt(0), Is.EqualTo("n"));		// assert body
		}
		...
		public void ElseBlockが正しく生成できる()
		{
			...
			Assert.That(firstStatemenet.Expressions.ElementAt(0), Is.EqualTo("fibonacci(n-2)+fibonacci(n-1)"));
		}
