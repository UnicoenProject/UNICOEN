...
namespace Ucpf.Core.Model {
	...
	public class UnifiedCast : UnifiedElement, IUnifiedExpression {
		...
		public UnifiedType CastType {
			...
			set {
				_castType = SetParentOfChild(value, _castType);
			}
		}
		...
		public IUnifiedExpression Expression{
			...
			set {
				_expression = SetParentOfChild(value, _expression);
			}
		}
		...
		public static UnifiedCast Create(UnifiedType type, IUnifiedExpression createExpression) {
