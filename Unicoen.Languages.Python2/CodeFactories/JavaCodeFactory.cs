...
namespace Unicoen.Languages.Python2.CodeFactories {
	public partial class Python2CodeFactory
		...
		bool IUnifiedModelVisitor<VisitorState, bool>.Visit(UnifiedSupplementType element, VisitorState state) {
			switch (element.Kind) {
		...
		bool IUnifiedModelVisitor<VisitorState, bool>.Visit(UnifiedGenericType element, VisitorState state) {
			element.Type.TryAccept(this, state);
			//state.Write("<");
		...
		bool IUnifiedModelVisitor<VisitorState, bool>.Visit(UnifiedArrayType element, VisitorState state) {
			element.Type.TryAccept(this, state);
			state.Write("[");
