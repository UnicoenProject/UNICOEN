...
// $ANTLR 3.2 Sep 23, 2009 12:02:23 JavaScript.g 2010-12-03 00:05:55
...
public partial class JavaScriptLexer : Lexer {
    ...
    public void mDoubleStringCharacter() // throws RecognitionException [2]
    {
    		try
    		{
            // JavaScript.g:391:2: (~ ( '\"' | '\\\\' | LT ) | '\\\\' EscapeSequence )
            int alt4 = 2;
    ...
    public void mSingleStringCharacter() // throws RecognitionException [2]
    {
    		try
    		{
            // JavaScript.g:396:2: (~ ( '\\'' | '\\\\' | LT ) | '\\\\' EscapeSequence )
            int alt5 = 2;
    ...
    public void mNonEscapeCharacter() // throws RecognitionException [2]
    {
    		try
    		{
            // JavaScript.g:413:2: (~ ( EscapeCharacter | LT ) )
            // JavaScript.g:413:4: ~ ( EscapeCharacter | LT )
            {
    ...
    public void mLineComment() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // JavaScript.g:883:2: ( '//' (~ ( LT ) )* )
            // JavaScript.g:883:4: '//' (~ ( LT ) )*
            {
            	Match("//"); if (state.failed) return ;

            	// JavaScript.g:883:9: (~ ( LT ) )*
            	do 
            	{
            	    int alt25 = 2;
    ...
    protected class DFA18 : DFA
    {
        ...
        {
            get { return "448:10: fragment DecimalLiteral : ( ( DecimalDigit )+ '.' ( DecimalDigit )* ( ExponentPart )? | ( '.' )? ( DecimalDigit )+ ( ExponentPart )? );"; }
        }
