                                        ...
                                        <cast_expression>
                                          <unary_expression>
                                            <postfix_expression>
                                              <primary_expression>
                                                <constant>
                                                  <TOKEN startline="2" startpos="8">10</TOKEN>
                                                </constant>
                                              </primary_expression>
                                            </postfix_expression>
                                          </unary_expression>
                                                                                  ...
                                                                                  <cast_expression>
                                                                                    <unary_expression>
                                                                                      <postfix_expression>
                                                                                        <primary_expression>
                                                                                          <constant>
                                                                                            <TOKEN startline="3" startpos="9">"aaa"</TOKEN>
                                                                                          </constant>
                                                                                        </primary_expression>
                                                                                      </postfix_expression>
                                                                                    </unary_expression>
                                                  ...
                                                  <cast_expression>
                                                    <unary_expression>
                                                      <postfix_expression>
                                                        <primary_expression>
                                                          <constant>
                                                            <TOKEN startline="4" startpos="9">30</TOKEN>
                                                          </constant>
                                                        </primary_expression>
                                                      </postfix_expression>
                                                    </unary_expression>
                                                                                            ...
                                                                                            <cast_expression>
                                                                                              <unary_expression>
                                                                                                <postfix_expression>
                                                                                                  <primary_expression>
                                                                                                    <constant>
                                                                                                      <TOKEN startline="5" startpos="10">"bbb"</TOKEN>
                                                                                                    </constant>
                                                                                                  </primary_expression>
                                                                                                </postfix_expression>
                                                                                              </unary_expression>
                                                                                  ...
                                                                                  <cast_expression>
                                                                                    <unary_expression>
                                                                                      <postfix_expression>
                                                                                        <primary_expression>
                                                                                          <constant>
                                                                                            <TOKEN startline="9" startpos="9">"ccc"</TOKEN>
                                                                                          </constant>
                                                                                        </primary_expression>
                                                                                      </postfix_expression>
                                                                                    </unary_expression>
