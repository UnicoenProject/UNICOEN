...
namespace Unicoen.Languages.CSharp {
	internal partial class Translator : IAstVisitor {
		...
		public object VisitTypeDeclaration(
		...
		public object VisitConstructorDeclaration(
				ConstructorDeclaration ctorDec,
				object data) {
		...
		public object VisitLocalVariableDeclaration(
				LocalVariableDeclaration dec,
				object data) {
			var modifier = ConvertModifiler(dec.Modifier);
			var type = ConvertType(dec.TypeReference);
			var decs =
		...
		public object VisitArrayCreateExpression(
				ArrayCreateExpression expr,
				object data) {
		...
		public object VisitObjectCreateExpression(
				ObjectCreateExpression expr,
				object data) {
		...
		public object VisitMemberReferenceExpression(
				MemberReferenceExpression expr,
				object data) {
			var target = ConvertExpression(expr.TargetObject);
		...
		public object VisitAttributeSection(
		...
		public object VisitDeclareDeclaration(
		...
		public object VisitOnErrorStatement(
		...
		public object VisitOptionDeclaration(
		...
		public object VisitQueryExpressionJoinClause(
				QueryExpressionJoinClause expr,
				object data) {
			throw new NotImplementedException();
		}
		...
		public object VisitQueryExpressionLetClause(
				QueryExpressionLetClause expr,
				object data) {
			throw new NotImplementedException();
		}

		public object VisitQueryExpressionLetVBClause(
				QueryExpressionLetVBClause expr,
				object data) {
			throw new NotImplementedException();
		}

		public object VisitQueryExpressionOrderClause(
				QueryExpressionOrderClause expr,
				object data) {
			throw new NotImplementedException();
		}

		public object VisitQueryExpressionOrdering(
				QueryExpressionOrdering expr,
				object data) {
			throw new NotImplementedException();
		}
		...
		public object VisitResumeStatement(
				ResumeStatement resumeStatement,
				object data) {
			throw new NotImplementedException();
		}

		public object VisitSizeOfExpression(
		...
		public object VisitTemplateDefinition(
		...
		public object VisitTryCatchStatement(
				TryCatchStatement tryCatchStatement,
				object data) {
			throw new NotImplementedException();
		}

		public object VisitTypeOfExpression(
				TypeOfExpression typeOfExpression,
				object data) {
			throw new NotImplementedException();
		}

		public object VisitTypeOfIsExpression(
		...
		public object VisitUncheckedStatement(
				UncheckedStatement uncheckedStatement,
				object data) {
			throw new NotImplementedException();
		}

		public object VisitUnsafeStatement(
		...
		public object VisitUsingDeclaration(
