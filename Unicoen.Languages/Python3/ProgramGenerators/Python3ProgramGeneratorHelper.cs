...
namespace Unicoen.Languages.Python3.ProgramGenerators {
	public static class Python3ProgramGeneratorHelper {
		...
		public static UnifiedSet<UnifiedParameter> CreateTypedargslist(
				XElement node) {
			Contract.Requires(node != null);
		...
		private static UnifiedExpression CreateNonlocal_stmt(XElement first) {
		...
		public static UnifiedElement CreateTestlist_star_expr(XElement node) {
			Contract.Requires(node != null);
