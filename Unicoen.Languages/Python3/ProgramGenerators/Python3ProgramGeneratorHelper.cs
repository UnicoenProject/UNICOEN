...
namespace Unicoen.Languages.Python3.ProgramGenerators {
    public static class Python3ProgramGeneratorHelper {
        ...
        public static UnifiedAnnotationCollection CreateDecorators(
                XElement node) {
            Contract.Requires(node != null);
        ...
        public static UnifiedParameterCollection CreateTypedargslist(
                XElement node) {
            Contract.Requires(node != null);
        ...
        public static UnifiedParameterCollection CreateVarargslist(
                XElement node) {
            Contract.Requires(node != null);
        ...
        public static UnifiedArgumentCollection CreateSubscriptlist(
                XElement node) {
            Contract.Requires(node != null);
