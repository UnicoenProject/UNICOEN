...
namespace Unicoen.Languages.Python3.ModelFactories {
	public class Python3ModelFactory : ModelFactory {
		public static Python3ModelFactory Instance = new Python3ModelFactory();
		...
		public override UnifiedProgram GenerateWithouNormalizing(string code) {
			...
			return Python3ModelFactoryHelper.CreateFile_input(ast);
		}
	}
}