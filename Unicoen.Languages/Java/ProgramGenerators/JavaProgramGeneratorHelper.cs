...
namespace Unicoen.Languages.Java.ProgramGenerators {
	public static class JavaProgramGeneratorHelper {
		...
		public static UnifiedComment CreateComment(XElement node) {
		...
		public static IEnumerable<UnifiedClassLikeDefinition>
			...
			if (node.FirstElement().Name() == "classOrInterfaceDeclaration") {
				yield return
						CreateClassOrInterfaceDeclaration(node.FirstElement());
			}
		}

		public static UnifiedClassLikeDefinition
				CreateClassOrInterfaceDeclaration(
				XElement node) {
			Contract.Requires(node != null);
		...
		public static UnifiedClassLikeDefinition CreateClassDeclaration(
				XElement node) {
			Contract.Requires(node != null);
		...
		public static UnifiedBlock CreateEnumBody(XElement node) {
			...
			if (enumBodyDeclarationsNode != null) {
				block.AddRange(
						CreateEnumBodyDeclarations(enumBodyDeclarationsNode));
			}
			return block;
		}
		...
		public static UnifiedVariableDefinitionList CreateEnumConstants(
			...
			return
					UnifiedVariableDefinitionList.Create(
							node.Elements("enumConstant").Select(
									CreateEnumConstant));
		}

		public static UnifiedVariableDefinition CreateEnumConstant(
				XElement node) {
			Contract.Requires(node != null);
		...
		public static IEnumerable<UnifiedExpression> CreateEnumBodyDeclarations
				(
				XElement node) {
			Contract.Requires(node != null);
		...
		public static UnifiedInterfaceDefinition
		...
		public static IEnumerable<UnifiedExpression>
		...
		public static IEnumerable<UnifiedExpression> CreateQualifiedNameList(
				XElement node) {
			Contract.Requires(node != null);
		...
		public static UnifiedExpression CreateQualifiedName(XElement node) {
			Contract.Requires(node != null);
		...
		public static UnifiedExpression CreateElementValue(XElement node) {
			Contract.Requires(node != null);
		...
		public static UnifiedExpression CreateElementValueArrayInitializer(
				XElement node) {
			Contract.Requires(node != null);
		...
		public static IEnumerable<UnifiedExpression> CreateBlockStatement(
				XElement node) {
			Contract.Requires(node != null);
		...
		public static IEnumerable<UnifiedExpression> CreateExpressionList(
				XElement node) {
			Contract.Requires(node != null);
		...
		public static UnifiedExpression CreateExpression(XElement node) {
			...
			return UnifiedProgramGeneratorHelper.
					CreateBinaryExpressionForRightAssociation(
							node, CreateConditionalExpression, CreateExpression,
							Sign2BinaryOperator);
		}
		...
		public static UnifiedExpression CreateConditionalOrExpression(
				XElement node) {
			Contract.Requires(node != null);
		...
		public static UnifiedExpression CreateConditionalAndExpression(
				XElement node) {
			Contract.Requires(node != null);
		...
		public static UnifiedExpression CreateInstanceOfExpression(
				XElement node) {
			Contract.Requires(node != null);
			 ...
			 */
			return UnifiedProgramGeneratorHelper.CreateBinaryExpression(
					node, CreateRelationalExpression, CreateType,
					Sign2BinaryOperator);
		}
		...
		public static UnifiedExpression CreateVariableInitializer(
				XElement node) {
			Contract.Requires(node != null);
		...
		public static UnifiedLiteral CreateFloatLiteral(XElement node) {
			...
			return UnifiedFractionLiteral.Create(
					d, UnifiedFractionLiteralKind.Single);
		}
		...
		public static UnifiedLiteral CreateDoubleLiteral(XElement node) {
			...
			return UnifiedFractionLiteral.Create(
					d, UnifiedFractionLiteralKind.Double);
		}
